...
class MobileViT(nn.Module):
    def __init__(self, features_list, d_list, transformer_depth, expansion):
...
def MobileViT_XXS():
    ...
    model_xxs = MobileViT(cfg_xxs["features"], cfg_xxs["d"], cfg_xxs["layers"], cfg_xxs["expansion_ratio"])
    return model_xxs

def MobileViT_XS():
    cfg_xs = model_cfg["xs"]
    model_xs = MobileViT(cfg_xs["features"], cfg_xs["d"], cfg_xs["layers"], cfg_xs["expansion_ratio"])
    return model_xs

def MobileViT_S():
    cfg_s = model_cfg["s"]
    model_s = MobileViT(cfg_s["features"], cfg_s["d"], cfg_s["layers"], cfg_s["expansion_ratio"])
    return model_s
