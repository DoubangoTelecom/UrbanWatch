...
BATCH_SIZE = 1 # "B>1" not supported
...
def main(cfg, args):
    ...
    for i, platform in enumerate(platforms):
        ...
        rknn.config(
            ...
            mean_values=cfg.model.normalize[0], 
            std_values=cfg.model.normalize[1],
        ...
        ret = rknn.export_rknn(os.path.join(rknn_folder, 'aocr_{}.rknn.{}'.format(args.target, platform)))
